		...
		<div class="modal-dialog">
			...
			<div class="modal-body">
				 <form role="form" id="sign_up" class="login_form" method="post">
					...
					<div class="form-group">
						<label for="exampleInputPassword1">ID/Passport NO.(required for security reasons)</label>
						<input name="idno" type="text" class="form-control" id="exampleInputPassword1" placeholder="idno" required>
					</div>
